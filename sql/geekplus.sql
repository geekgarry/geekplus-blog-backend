...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dept` VALUES (100, 0, '0', '麦壳畅想', 0, '麦客', '13465898832', 'xxx@xxx.xxx', '0', '0', 'admin', '2023-07-20 02:49:10', 'admin', '2023-07-25 10:47:14');
INSERT INTO `sys_dept` VALUES (101, 100, '0,100', '畅想核心', 1, '麦客', '13465898832', 'xxx@xxx.xxx', '0', '0', 'admin', '2023-07-20 02:49:14', 'admin', '2023-07-25 10:47:14');
INSERT INTO `sys_dept` VALUES (102, 100, '0,100', '南京分公司', 2, '麦壳', '15888888888', 'xxx@xxx.xxx', '0', '0', 'admin', '2023-07-20 02:49:19', '', '2023-07-24 05:11:46');
INSERT INTO `sys_dept` VALUES (103, 101, '0,100,101', '软件开发部门', 1, '麦客', '13465898832', 'xxx@xxx.xxx', '0', '0', 'admin', '2023-07-20 02:49:24', 'admin', '2023-07-25 10:47:14');
INSERT INTO `sys_dept` VALUES (104, 101, '0,100,101', '市场部门', 2, '麦客', '13465898832', 'xxx@xxx.xxx', '0', '0', 'admin', '2023-07-20 02:49:32', 'admin', '2023-07-25 10:47:14');
INSERT INTO `sys_dept` VALUES (105, 101, '0,100,101', '测试部门', 3, '麦客', '13465898832', 'xxx@xxx.xxx', '0', '0', 'admin', '2023-07-20 02:49:37', 'admin', '2023-07-25 10:47:14');
INSERT INTO `sys_dept` VALUES (106, 101, '0,100,101', '财务部门', 4, '麦客', '13465898832', 'xxx@xxx.xxx', '0', '0', 'admin', '2023-07-20 02:49:41', 'admin', '2023-07-25 10:47:14');
INSERT INTO `sys_dept` VALUES (107, 101, '0,100,101', '运维部门', 5, '麦客', '13465898832', 'xxx@xxx.xxx', '0', '0', 'admin', '2023-07-20 02:49:46', 'admin', '2023-07-25 10:47:14');
INSERT INTO `sys_dept` VALUES (108, 102, '0,100,102', '市场部门', 1, '极客普拉斯', '15888888888', 'xxx@xxx.xxx', '0', '0', 'admin', '2023-07-20 02:49:50', '', '2023-07-24 05:11:41');
INSERT INTO `sys_dept` VALUES (109, 102, '0,100,102', '财务部门', 2, '极客普拉斯', '15888888888', 'xxx@xxx.xxx', '0', '0', 'admin', '2023-07-20 02:49:53', '', '2023-07-24 05:11:46');
INSERT INTO `sys_dept` VALUES (110, 101, '0,100,101', '网络安全部门', 6, '极客普拉斯', '13333333333', 'xxx@xxx.xxx', '0', '0', '', '2023-07-20 03:44:03', 'admin', '2023-07-25 10:47:14');
COMMIT;
...
INSERT INTO `sys_menu` VALUES (159, '文件管理', 1, 10, 'fileManager', 'system/file/index', 1, 0, 'M', 0, 0, NULL, 'category', '', '2025-03-26 23:06:51', '', NULL, '');
INSERT INTO `sys_menu` VALUES (160, 'JVM监控', 2, 5, 'jvm', 'monitor/jvm/index', 1, 0, 'M', 0, 0, NULL, 'java', '', '2025-04-11 21:36:44', '', NULL, '');
...
INSERT INTO `sys_menu` VALUES (600, '文件管理', 1, 10, 'fileManager', 'system/file/index', 1, 0, 'M', 0, 0, NULL, 'category', '', '2026-03-26 23:06:51', '', '2026-03-26 23:22:27', '');
INSERT INTO `sys_menu` VALUES (601, '系统参数', 1, 8, 'config', 'system/config/index', 1, 0, 'M', 0, 0, 'system:config:list', 'list', '', '2025-10-23 09:16:57', '', '2025-11-27 18:53:46', '');
INSERT INTO `sys_menu` VALUES (1061, '数据字典', 1, 6, 'sysDict', 'system/dict/index', 1, 0, 'M', 0, 0, 'system:sysDict:list', 'nested', 'gp', '2025-09-21 18:20:15', '', '2025-11-21 18:30:21', '数据字典菜单');
INSERT INTO `sys_menu` VALUES (1062, '字典数据项', 1, 7, 'dictData', 'system/dict/data', 1, 0, 'M', 1, 0, 'system:dictData:list', 'nested', 'gp', '2025-09-21 18:22:06', '', '2025-11-21 18:30:40', '数据字典数据项菜单');
INSERT INTO `sys_menu` VALUES (1063, '数据字典查询', 1061, 1, '#', '', 1, 0, 'B', 0, 0, 'system:sysDict:detail', '#', 'gp', '2025-09-21 18:20:15', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1064, '数据字典新增', 1061, 2, '#', '', 1, 0, 'B', 0, 0, 'system:sysDict:add', '#', 'gp', '2025-09-21 18:20:15', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1065, '数据字典修改', 1061, 3, '#', '', 1, 0, 'B', 0, 0, 'system:sysDict:update', '#', 'gp', '2025-09-21 18:20:15', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1066, '数据字典删除', 1061, 4, '#', '', 1, 0, 'B', 0, 0, 'system:sysDict:delete', '#', 'gp', '2025-09-21 18:20:15', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1067, '数据字典导出', 1061, 5, '#', '', 1, 0, 'B', 0, 0, 'system:sysDict:export', '#', 'gp', '2025-09-21 18:20:15', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1068, '数据字典数据项查询', 1062, 1, '#', '', 1, 0, 'B', 0, 0, 'system:dictData:detail', '#', 'gp', '2025-09-21 18:22:06', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1069, '数据字典数据项新增', 1062, 2, '#', '', 1, 0, 'B', 0, 0, 'system:dictData:add', '#', 'gp', '2025-09-21 18:22:06', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1070, '数据字典数据项修改', 1062, 3, '#', '', 1, 0, 'B', 0, 0, 'system:dictData:update', '#', 'gp', '2025-09-21 18:22:06', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1071, '数据字典数据项删除', 1062, 4, '#', '', 1, 0, 'B', 0, 0, 'system:dictData:delete', '#', 'gp', '2025-09-21 18:22:06', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1072, '数据字典数据项导出', 1062, 5, '#', '', 1, 0, 'B', 0, 0, 'system:dictData:export', '#', 'gp', '2025-09-21 18:22:06', '', NULL, '');
COMMIT;
...
INSERT INTO `sys_user` VALUES (3, 103, 'geekplus', '极客普拉斯', '1', 'geekcjj@xxx.xxx', '12233556789', '1', '/profile/avatar/2022/08/01/cfd6ea74-b706-42e7-a582-792e378bad63.jpeg', 'c0ac167302e2bbea4137501572a115a5', '0', '0', '117.89.1.32', '2022-08-11 12:06:44', NULL, '2022-07-02 06:36:44', NULL, '2022-08-11 12:06:44', '极客普拉斯');
...
-- ----------------------------
-- 系统文件记录表，用于记录上传文件的元数据（根据项目情况选择使用）
-- ----------------------------
CREATE TABLE `sys_file` (
  ...
  `file_type` varchar(50) DEFAULT NULL COMMENT '文件后缀类型',
  `is_dir` tinyint(1) DEFAULT '0' COMMENT '是否是文件夹(0否 1是)',
