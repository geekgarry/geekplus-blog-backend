## geekplus-blog-admin-api
#### 博客后台管理系统,使用SpringBoot+mybatis+reids，权限框架采用shiro，结合jwt实现用户认证，逆向工程生成模版
...
> 用户登录密码默认为123456
##### [前端项目] [https://github.com/geekgarry/geekplus-blog-frontend](https://github.com/geekgarry/geekplus-blog-frontend)
