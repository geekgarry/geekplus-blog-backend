...
import com.geekplus.framework.interceptor.CookieToHeaderInterceptor;
import com.geekplus.framework.interceptor.RepeatSubmitInterceptor;
import com.geekplus.framework.interceptor.VisitInterceptor;
 ...
 * author     : geekplus
 * date       : 6/26/23 03:44
 * description: web配置器，负责管理资源映射和配置拦截器/过滤器使用 extends WebMvcConfigurationSupport
 */
@Configuration
