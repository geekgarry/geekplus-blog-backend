...
public class SysUserOnlineController extends BaseController {
    ...
    public Result forceLogout(@PathVariable String userKey)
    {
        redisUtil.del(Constant.PRE_REDIS_USER_TOKEN + userKey);
        redisUtil.del(Constant.USER_ONLINE_TOKENS_PREFIX + userKey);
