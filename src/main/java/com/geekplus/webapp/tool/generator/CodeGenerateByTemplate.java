...
//            writer.close();
    ...
    public static List<Template> templateList() throws IOException {
         ...
         */
        // 1.mapper 这些是生成代码文件
        templates.add(configJava.getTemplate("mapper.ftl"));
        // 2.service
        templates.add(configJava.getTemplate("service.ftl"));
        // 3.serviceImpl
        templates.add(configJava.getTemplate("service-impl.ftl"));
        // 4.entity
        templates.add(configJava.getTemplate("entity.ftl"));
        // 5.controller
