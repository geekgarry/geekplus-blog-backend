...
public class GenCodeServiceImpl implements GenCodeService {
     ...
     */
    @Override
    public List<TableInfo> getAllListTable(TableInfo tableInfo) {
        return tableMapper.listAllTable(tableInfo);
    }
    ...
    @Override
    public List<Map<String, Object>> previewCodeByTable(TableInfo tableInfo) {
        return CodeGenerateByTemplate.genPreviewCodeByTemplate(getTableInfoByGenTable(tableInfo));
    }
