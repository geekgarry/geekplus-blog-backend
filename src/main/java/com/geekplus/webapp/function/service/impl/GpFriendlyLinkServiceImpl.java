...
import com.geekplus.webapp.function.mapper.GpFriendlyLinkMapper;
...
public class GpFriendlyLinkServiceImpl implements IGpFriendlyLinkService
{
    ...
    {
        gpFriendlyLink.setCreateTime(DateUtil.getNowDate());
    ...
    {
        gpFriendlyLink.setUpdateTime(DateUtil.getNowDate());
