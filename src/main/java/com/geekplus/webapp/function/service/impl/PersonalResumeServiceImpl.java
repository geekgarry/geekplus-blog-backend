...
import com.geekplus.webapp.function.mapper.PersonalResumeMapper;
...
public class PersonalResumeServiceImpl implements IPersonalResumeService
{
    ...
    @Override
    public String importPersonalResume(List<PersonalResume> personalResumes, boolean updateSupport) {
