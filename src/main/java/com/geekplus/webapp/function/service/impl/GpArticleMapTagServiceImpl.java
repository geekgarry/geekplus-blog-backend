...
import com.geekplus.webapp.function.mapper.GpArticleMapTagMapper;
...
public class GpArticleMapTagServiceImpl implements IGpArticleMapTagService
{
     ...
     * 删除文章标签映射信息
     *
     * @param gpArticleMapTag 文章标签映射ID
     * @return 结果
     */
    @Override
    public int deleteGpArticleMapTagBy(GpArticleMapTag gpArticleMapTag) {
        return gpArticleMapTagMapper.deleteGpArticleMapTagBy(gpArticleMapTag);
    }
}
