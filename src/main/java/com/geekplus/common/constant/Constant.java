...
public interface Constant {
	 ...
	 */
	public String PRE_REDIS_USER_TOKEN = "user:login:";

	public String USER_ONLINE_TOKENS_PREFIX = "user:online_tokens:"; // 用户在线 JTI 列表前缀
	 ...
	 * 参数管理 cache key
	 */
	public String SYS_CONFIG_KEY = "sys_config:";
}
