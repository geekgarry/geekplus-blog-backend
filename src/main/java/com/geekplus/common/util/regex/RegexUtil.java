...
//		String input = "Here are some URLs: http://xxx.xxx.xx/api/dsnfkdgnj, https://xxx.cc/api/dnghg, /geekplus-app/上课呢芳, and a normal word.";
//		String input2 = "https://xxx.xx/api/profile/article/2023/12/01/7a7d087c.png";
